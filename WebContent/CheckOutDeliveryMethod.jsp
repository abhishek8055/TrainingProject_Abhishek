...
<!-- BREADCRUMB STARTS -->
		<div class="row" id="header" style="font-size:14px">
			<div class="col-md-6 pt-4 d-flex justify-content-center">
				<h5><b>CHECKOUT-DELIVERY METHOD</b></h5>
			</div>
			<div class="col-md-4 offset-md-2 col-xs-12 col-sm-12 d-flex justify-content-center">
        		<nav aria-label="breadcrumb">
					<ol class="breadcrumb" style="background:none">
						<li class="breadcrumb-item"><a href="Home.jsp">HOME</a></li>
						<li class="breadcrumb-item active font-weight-bold">CHECKOUT-DELIVERY METHOD</li>
					</ol>
				</nav>
			</div>	 	
	   </div>	
	  	...
	  	<!-- COLUMN 1 STARTS -->
	    		<div class="col-md-7 offset-md-1">
					<ul class="nav nav-pills">
  						...
  						<li class="nav-item"><a class="nav-link active addressId"><i class="fa fa-truck"></i>&nbsp;Delivery Method</a></li>
					...
					<div class="row mt-5">
				  		<div class="col-md-6">
					  		<div class="card text-center">
							 	<div class="card-header">PRIME DELIVERY</div>
							  	<div class="card-body">
							    	<p class="card-title">Takes only One business day!</p>
							  	</div>
					  	...
					  	<div class="col-md-6 mb-2">
					  		<div class="card text-center">
							 	<div class="card-header">REGULAR DELIVERY</div>
							  	<div class="card-body">
							    	<p class="card-title">Takes 3-4 business days only!</p>
							  	</div>
							  	<div class="card-footer text-muted">
							    	<a href="#" class="btn btn-danger btn-sm">SELECT</a>
							 	 </div>
					...
					<div class="row" style="background:	#F5F5F5; padding-top:15px; padding-bottom:15px; margin-top:30px">
						...
						<div class="col-md-6 col-sm-12 d-flex justify-content-end">
							<a href="CheckOutPaymentMethod.jsp" style="background:#F5F5F5" class="button button1" name="contact">
				       			</span>CONTINUE TO PAYMENT METHOD&nbsp;<span class="fa fa-chevron-right">
				       		</a>
						</div>
  					</div>	    
				</div>
